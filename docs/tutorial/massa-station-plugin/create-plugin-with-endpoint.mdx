...
import (
    ...
    "my-plugin/station-massa-hello-world/api/server/restapi/operations"
)
...
```bash
curl -X PUT "http://station.massa/plugin/my-name/my-plugin/api/hello?name=John" -H  "accept: application/json"
```
