...
1. **Mainnet:** enabling bridging from Ethereum or BNB Smart Chain (BSC) to Massa.
2. **Testnet:** enabling bridging from Sepolia Testnet or BSC Testnet to Massa Buildnet.

Massa Bridge currently enables bridging Circle USD, DAI, and Wrapped Ether from Ethereum, and Bridged USDT and Ethereum Token from BNB Smart Chain. 
