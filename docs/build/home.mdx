...
<FeatureList>
    <Feature docName="./quickstart" title="Quickstart" content="Create your first dApp." icon="⚡" />
    <Feature docName="./wallet/intro" title="Wallets" content="Store your assets." icon="👛" />
    <Feature docName="./networks-faucets" title="Networks & Faucets" content="Chose the right network." icon="🌐" />
</FeatureList>
