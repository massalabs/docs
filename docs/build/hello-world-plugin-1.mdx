...
## What is a Massa Station and Massa Station plugins?
On feature of the Massa blockchain is what we call the Decentralized Web. With Massa, you can host and serve web-applications directly on chain, hence removing the need for a trusted intermediary. Massa Station is the gateway to access these applications.

:::info
Once installed on your machine, Massa Station will allow your browser to resolve `.massa` urls and interact with decentralized applications hosted on Massa. When using Massa Station, the `.massa` extension indicates that you are visiting a website that is hosted on-chain, and directly served to you. You can learn more about the Decentralized Web and Massa Station [here](/docs/learn/decentralized-web).
:::

But Massa Station is more than just a custom DNS, it is also a module manager. 
<!--TODO: add for context about massa station features-->

A Massa Station plugin is a piece of software that extends the functionality of Massa Station. 
<!--TODO: add for context about plugins-->

## What are we going to do ?
In this tutorial, we are going to build a simple "Hello, World!" Massa Station plugin. 
