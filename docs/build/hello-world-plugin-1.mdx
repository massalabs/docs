...
#### Step 1: Add a new endpoint to the swagger file
...
#### Step 2: Generate the server stub
...
#### Step 5: Re-build and re-deploy the plugin
...
#### Step 7: Re-build and re-deploy the plugin
...
#### Step 8: Restart Massa Station and access the module page
Restart Massa Station and access [the module page](https://station.massa/web/store). You should see the plugin in the list of available plugins.
