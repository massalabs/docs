...
<Tabs>
  <TabItem value="buildnet" label="👷 BuildNet" default>
    <table>
      <tr>
        <td>🔗 Public API</td>
        <td><a href="https://buildnet.massa.net/api/v2">https://buildnet.massa.net/api/v2</a></td>
      </tr>
      <tr>
        <td>🪙 Faucet</td>
        <td><a href="https://discord.com/channels/828270821042159636/1097797634065956915">#buildernet-faucet Discord channel</a></td>
      </tr>
      <tr>
        <td>🕵️ Explorer</td>
        <td><a href="https://buildnet.massa.net">https://buildnet.massa.net</a></td>
      </tr>
    </table>
  </TabItem>
  <TabItem value="testnet" label="🧑‍🔬 TestNet">
    <table>
      <tr>
        <td>🔗 Public API</td>
        <td><a href="https://test.massa.net/api/v2">https://test.massa.net/api/v2</a></td>
      </tr>
      <tr>
        <td>🪙 Faucet</td>
        <td><a href="https://discord.com/channels/828270821042159636/866190913030193172">#testnet-faucet Discord channel</a></td>
      </tr>
      <tr>
        <td>🕵️ Explorer</td>
        <td><a href="https://test.massa.net/v1/">https://test.massa.net/v1/</a></td>
      </tr>
    </table>
  </TabItem>
</Tabs>
...
- A Massa wallet (Don't have one yet? Generate addresses on the [Explorer website](https://massa.net/explorer))
- A [discord account](https://support.discord.com/hc/en-us/articles/360033931551-Getting-Started)

And remember, each faucet allows for only one request per day.
