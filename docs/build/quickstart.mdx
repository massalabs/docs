...
:::info
Not sure how to create and fund a Massa wallet? Check our guide [here](XXX).
:::
...
:::info
For more comprehensive details on the layout of the smart contract project, please refer to our guide [here](XXX).
...
:::caution
You can find the compatible version of the Massa tools [right here](XXX).
:::
