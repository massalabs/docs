...
:::info
Each smart contract has its own storage that can be used to store data. It is also a key-value store. Learn more about smart contracts [here](docs/build/smart-contract/intro).
:::
