...
The smart contract is the backbone of our application. It is a self-executing contract with the terms of the agreement directly written into lines of code. We will use AssemblyScript to write our smart contract. This contract will hold a single greeting message that can be updated and read.
