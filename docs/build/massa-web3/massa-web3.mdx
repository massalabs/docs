...
- This documentation represents the latest version of the Massa Web3 JS Library as of August 2024. However, please be aware that a significant update is coming soon. The next version will introduce new features, improvements, and potentially some changes to the existing API.
...
We already started to add the new documentation for the upcoming version. You can find it [here](/docs/build/web3/web3-libraries-intro).
:::
