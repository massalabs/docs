...
:::info
Please note that specifying a base account is only optional at this point. You will learn more about the base account in the [Wallet Operations](massa-web3/massa-web3-wallet) section.
:::
