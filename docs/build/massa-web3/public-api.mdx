...
Get current [cliques](https://web3.docs.massa.net/interfaces/IClique.html).
...
Returns the details of [endorsements](https://web3.docs.massa.net/interfaces/IEndorsement.html) provided as a list of endorsement IDs.
