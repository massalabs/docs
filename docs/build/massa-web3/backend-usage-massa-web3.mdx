...
you will need to pass the secret keys as environment variables. Initialization of the client is shown in the [introduction](/docs/build/massa-web3#without-wallet-provider)
of the Massa Web3.
