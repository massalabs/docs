...
In addition, the library includes a [collection of handy utility functions](/docs/build/tools/massa-web3/massa-web3-utils) (e.g conversion between different units, etc).
