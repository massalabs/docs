...
**JavaScript**: see
[massa-web3.js](https://github.com/massalabs/massa-web3).

**Postman**: is a tool for software developers to create, test and debug
API requests. More details can be found in [Postman learning
...
In this section we'll learn how to interact with Massa blockchain via
[curl commands which will create JSON-RPC
[request](https://www.jsonrpc.org/specification#request_object) calls.
...
a.k.a. **user mode** methods (running on
...
[cliques](https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#block-cliques)
of the graph.
...
[stakers](https://docs.massa.net/en/latest/testnet/staking.html) and
...
[address](https://docs.massa.net/en/latest/general-doc/architecture/archi-intro.html#address)
...
[graph](https://docs.massa.net/en/latest/technical-doc/glossary.html#graph-stuff)
...
Get information about [block(s)
\<https://docs.massa.net/en/latest/general-doc/architecture/archi-intro.html#block\>\_\_
...
Get information about
[operation](https://docs.massa.net/en/latest/general-doc/architecture/archi-intro.html#operation)
...
Get information about
[endorsement](https://docs.massa.net/en/latest/general-doc/architecture/endorsements.html)
(s) (content, finality \...)
