...
- **Public API**: used for blockchain interactions. Default port is:
  33037 e.g. `grpc://localhost:33037`
- **Private API**: used for node management. Default port is: 33038 e.g. `grpc://localhost:33038`
...
<span class="title-ref">.proto</span> files to include in the build process.
