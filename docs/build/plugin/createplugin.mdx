...
This tutorial will show you how to create a simple plugin using Go and Swagger. It is possible to use other languages and frameworks such as explained in the [plugin guidelines](./guidelined.mdx).
...
- You should see the following output:
- Add the right endpoint to the `swagger.yml` file.
