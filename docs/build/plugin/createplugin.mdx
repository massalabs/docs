...
Here, we will rebuild the “Hello world” plugin from scratch, you can access it [here](https://github.com/massalabs/station-massa-hello-world/tree/main) as an example.
...
- Create the file `Taskfile.yml`.
- Paste the content from the following [file](https://github.com/massalabs/station-massa-hello-world/blob/main/Taskfile.yml).
- Run `task install`
...
- Run `task generate` to generate the API

  > This will generate a `cmd/station-massa-hello-world-server/station-massa-hello-world.go` file, that will be the entry point of your plugin
...
- Set the handler for the endpoints
  - create a station-massa-hello-world.go file in the root of your project: `touch station-massa-hello-world.go`
...
<!-- TO DO : add a note about importing the swagger file in postman to perform the API calls -->
...
### Part 2: Createconnect the plugin on MassaStation

Here we will see how to connect the plugin to MassaStation.

- update the imported packages in the `station-massa-hello-world.go` file:
...
import (
	...
	"github.com/my-username/station-massa-hello-world/api"
	"github.com/my-username/station-massa-hello-world/api/server/restapi"
	"github.com/my-username/station-massa-hello-world/api/server/restapi/operations"
	"github.com/my-username/station-massa-hello-world/web"
	"github.com/rs/cors"
)
```
...
```bash
curl -X PUT "http://station.massa/plugin/my-name/hello-world/api/hello?name=John" -H  "accept: application/json"
```
...
- Navigate to `http://station.massa/plugin/my-name/hello-world/web/index.html` and you should access the html page you created.
- You're all set !
