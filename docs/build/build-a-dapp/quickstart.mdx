...
:::info
Not sure how to create and fund a Massa wallet? Check our guide [here](/docs/build/tools/wallet/intro).
:::
...
- Review more detailed guides on [smart contract development](/docs/build/build-a-dapp/smart-contract/intro).
