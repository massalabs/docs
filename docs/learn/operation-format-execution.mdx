...
In Massa, there is no Nonce in operations.
...
| Field                     | Description                                                     | Type                              |
+===========================+=================================================================+===================================+
| `version number`          | Varint unsigned 64-bit integer using protobuf conventions.      | between 1 and 10 bytes (inclusive) |
...
| Field               | Description                                                                                           | Type                                        |
+=====================+=======================================================================================================+=============================================+
| `version number`    | Varint unsigned 64-bit integer using protobuf conventions                                             | Between 1 (included) and 10 (included) bytes |
+---------------------+-------------------------------------------------------------------------------------------------------+---------------------------------------------+
...
| Field                      | Description                                                                                    | Type                                        |
+============================+================================================================================================+=============================================+
| `version number`           | Varint unsigned 64-bit integer using protobuf conventions. Indicates the secret key version.   | Between 1 (included) and 10 (included) bytes |
+----------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
...
Using this data, and through symmetries in the ed25519 curve, it is possible to deduce the `x` coordinate.
...
| Field               | Description                                                | Type                                        |
+=====================+============================================================+=============================================+
| `address category`  | Varint unsigned 64-bit integer using protobuf conventions: | Between 1 (included) and 10 (included) bytes |
...
|                     | as detailed above, but without the category field (only version then hash).                        | 37 to 62 bytes                            |
+---------------------+----------------------------------------------------------------------------------------------------+-------------------------------------------+
...
|                     | The mantissa is deduced by multiplying the represented coin amount by `1e9`.                          | 10 bytes (included)        |
+---------------------+-------------------------------------------------------------------------------------------------------+---------------------------+
...
| Field                  | Description                                                                    | Type                                                  |
+========================+================================================================================+=======================================================+
| `max_gas`              | Varint unsigned 64-bit integer using protobuf conventions.                     | From 1 byte (included) to 10 bytes (included)          |
+------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------+
| `coins`                | Coin amount binary serialization (see [Coin amount section](#coin-amounts)).   | From 1 byte (included) to 10 bytes (included)          |
+------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------+
...
+------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------+
| `param_length`         | Varint unsigned 64-bit integer using protobuf conventions.                     | From 1 byte (included) to 10 bytes (included)          |
+------------------------+--------------------------------------------------------------------------------+-------------------------------------------------------+
...
The broadcasting thread keeps submitted operations in memory for at least 32 seconds with a cap of 32000 operations being propagated at the same time. 
...
* the operations are checked for legality with batched parallel signature verification (see [operation legality section](#operation-format-and-legality))
  * if any of the operations is not legal, the batch is dropped, and the sender peer is banned
...
Blocks contain arbitrary operations chosen by the block producer.
...
Final execution is prioritized over candidate execution:
...
and operations that overflow their sender's candidate balance given those cumulated spending are discarded.
