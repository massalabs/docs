...
## API Module
The API Module is the public window of the node to the rest of the world. It allows for interactions with external clients or factories via a `gRPC (and JSON RPC?)` protocol.

:::danger
To do:
- define which gRPC or JSON RPC we mention here.
- Redirect to API documentation form here.
:::
...
:::danger
1. what does it use if not JSON RPC?
2. If we don't mention JSON RPC in the API module then we don't need to make this comparison here.
:::
...
:::note
More about slashing  mechanism here: [insert link to the new section on slashing]
:::
...
:::danger
add diagram from here https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#selector-module-proof-of-stake-sybil-resistance
:::
...
:::danger
add diagram from https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#block-cliques
:::
...
:::danger
add diagram 2 from https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#block-cliques
:::
...
:::danger
add diagram 3 from https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#block-cliques
:::
...
:::danger
copy other 3 paragraphs from [here](https://docs.massa.net/en/latest/general-doc/architecture/archi-global.html#finalized-blocks-stale-blocks) using [Katex for math equations](https://docusaurus.io/docs/markdown-features/math-equations)
:::
