...
$$
Cost_{massa} = 0.001 + 0.0001 * BytecodeSize + 0.0001 * \sum_i (4 + DataStoreKey_i + DatastoreValue_i)
$$
...
In case you then delete the "nickname" datastore entry (with the "kev" value),
`0.0001 * (4 + 8 + 3) = 0.0015` coins are refunded. 
