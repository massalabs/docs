...
the selection process [here](/docs/learn/architecture#selector-module-proof-of-stake-sybil-resistance), and the proof of stake sybil resistance mechanism [here](/ddocs/learn/architecture#selector-module-proof-of-stake-sybil-resistance)),
...
:::info
 Learn more about Autonomous Smart Contracts [here](/docs/learn/autonomous-sc).
:::
