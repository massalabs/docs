...
<table>
    <tr>
        <td><code>signature</code></td>
        <td colspan="2">See [Signature section](# Signature)</td>
    </tr>
    <tr>
        <td><code>sender public key</code></td>
        <td colspan="2">See [Public Key section](# Public key)</td>
    </tr>
    <tr>
        <td><code>serialized operation contents</code></td>
        <td colspan="2">See [Operation Contents section](# Operation contents)</td>
    </tr>
</table>
...
=======
Blake3 is 12 times faster than sha256 and is not subject to length extension attacks contrary to sha256.
...
>>>>>>> 0482895 (Adds links to inner sections)
...
<table>
    ...
    <tr>
        ...
        <td>32 bytes</td>
        <td>see [Operation contents hash section](#operation-contents-hash)</td>
    </tr>
</table>
...
<table>
    <tr>
        <td><code>fee</code></td>
        <td>from 1 byte (included) to 9 bytes (included)</td>
        <td>Coin amount in binary format (see [Coin amount section](#coin-amounts))</td>
    </tr>
    <tr>
...
<table>
    <tr>
        ...
        <td>Transfer destination address binary representation, see [Address section](#address).</td>
    </tr>
    <tr>
        <td><code>amount</code></td>
        <td>from 1(included) to 9(included) bytes</td>
        <td>Coin amount binary representation, see [Coin amount section](#coin-amounts).</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>from 1 byte (included) to 9 bytes (included)</td>
        <td>Coin amount binary serialization (see [Coin amount section](#coin-amounts)).</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>from 34 (included) to 50 bytes (included)</td>
        <td>Target address binary representation, see [Address section](#address).</td>
    </tr>
    <tr>
