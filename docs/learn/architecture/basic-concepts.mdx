...
Each address on Massa has a public and private key associated with it. This is how messages can be signed and identity enforced.
...
:::info
**There are two types of addresses on the Massa blockchain:**

1. User addresses: prefix AU + hash 

2. Smart contracts: prefix AS + hash
:::
