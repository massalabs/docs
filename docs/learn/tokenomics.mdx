...
![](Unlocked.png)
Note: This chart reflects the updated vesting schedule following the Decentralization Program adjustment implemented in January 2026.


## Decentralization Program Tokens Update

This section provides an update regarding the Decentralization Program tokens.

The Decentralization Program represents 30 percent of the total supply, corresponding to 300,000,000 MAS. In the initial ledger, these tokens were scheduled with a 60 month vesting period, including a 24 month cliff followed by 36 months of linear unlock. Tokens not distributed after 96 months were planned to be burned.

On January 15th, 2026, the network reached its 24th month since mainnet launch, marking the end of the cliff period. At this point, instead of allowing the tranche originally scheduled to unlock between month 24 and month 36 to continue toward the initial 60 month timeline, a decision was made to relock these tokens.
As a result, this tranche is now extended and will unlock between 60 and 72 months after mainnet launch, rather than being fully unlocked by month 60 as initially planned.

This adjustment does not modify the total allocation of the Decentralization Program. It only updates the unlock schedule to stay aligned with the long term decentralization goals of the network and to avoid premature supply release.

As of January 15th, 2026, tokens allocated to private sales and test phases have completed their vesting schedules and are fully unlocked.
