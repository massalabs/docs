...
These tables are obtained from the source code of the node, in the [massa repository](https://github.com/massalabs/massa/blob/MAIN.5.0/massa-models/src/config/constants.rs),
...
| VERSION | A string representing the network's version | `"MAIN.5.0"` currently deployed. |
