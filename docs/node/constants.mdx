...
This page describes the constants governing the behavior of the network and their values (that are the same for all nodes of a given network). These tables are obtained from the source code of the node, in the [constants.rs file](https://github.com/massalabs/massa/blob/MAIN.2.4/massa-models/src/config/constants.rs) of the massa repo.

## Constants common to all networks
...
## Constants common to all networks (Brought by MIP-0001)
