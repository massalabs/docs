...
- [Windows executable](https://github.com/massalabs/massa/releases/download/DEVN.28.2/massa_DEVN.28.2_release_windows.zip)
- [Linux binary](https://github.com/massalabs/massa/releases/download/DEVN.28.2/massa_DEVN.28.2_release_linux.tar.gz) - 
only works with libc2.28 and higher (for example Ubuntu 20.04 and higher)
- [MacOS binary](https://github.com/massalabs/massa/releases/download/DEVN.28.2/massa_DEVN.28.2_release_macos_aarch64.tar.gz)
- Other binaries can be found on https://github.com/massalabs/massa/releases/tag/DEVN.28.2
...
- install rust stable version: ```rustup toolchain install 1.74.0```
- set it as default: ```rustup default 1.74.0```
- check rust version: ```rustc --version```
...
- Open Windows Power Shell
    ...
    - Change default Rust to nightly: ```rustup default 1.74.0```
