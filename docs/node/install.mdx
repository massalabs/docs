...
- [Windows executable](https://github.com/massalabs/massa/releases/download/TEST.25.0/massa_TEST.25.0_release_windows.zip)
- [Linux binary](https://github.com/massalabs/massa/releases/download/TEST.25.0/massa_TEST.25.0_release_linux.tar.gz) - 
only works with libc2.28 and higher (for example Ubuntu 20.04 and higher)
- [MacOS binary](https://github.com/massalabs/massa/releases/download/TEST.25.0/massa_TEST.25.0_release_macos.tar.gz)
