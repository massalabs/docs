...
- [Windows executable](https://github.com/massalabs/massa/releases/download/TEST.24.1/massa_TEST.24.1_release_windows.zip)
- [Linux binary](https://github.com/massalabs/massa/releases/download/TEST.24.1/massa_TEST.24.1_release_linux.tar.gz) - 
only works with libc2.28 and higher (for example Ubuntu 20.04 and higher)
- [MacOS binary](https://github.com/massalabs/massa/releases/download/TEST.24.1/massa_TEST.24.1_release_macos.tar.gz)
