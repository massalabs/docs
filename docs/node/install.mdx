...
More info in the [FAQ](./faq.mdx).

:::

## From Thyra (simplest installation)

If you wish to run a Massa node with a couple of clicks only, you can download thyra app and activate the node-manager
...
1. Install thyra based on your OS:
    ...
    - MacOS
        ...
        [ARM](https://github.com/massalabs/thyra/releases/latest/download/thyra-installer_darwin_arm64.tar.gz)
        - For Intel CPUs (i5, i7...), use
        [AMD](https://github.com/massalabs/thyra/releases/latest/download/thyra-installer_darwin_amd64.tar.gz)
    - [Linux](https://github.com/massalabs/thyra/releases/latest/download/thyra-installer_linux_amd64.tar.gz)
2. Start thyra using the icon tray. If you need help,
[this page](https://github.com/massalabs/thyra/blob/main/INSTALLATION.md) can help.
3. [Configure your VPS](https://github.com/massalabs/thyra-node-manager-plugin/wiki) and go to
[Thyra home page](https://my.massa/thyra/home/).
...
[open a question](https://github.com/massalabs/thyra/issues/new) describing your problem.
...
go the the next step: [Running a node](./run.mdx).

- [Windows executable](https://github.com/massalabs/massa/releases/download/TEST.22.1/massa_TEST.22.1_release_windows.zip)
- [Linux binary](https://github.com/massalabs/massa/releases/download/TEST.22.1/massa_TEST.22.1_release_linux.tar.gz) - 
only works with libc2.28 and higher (for example Ubuntu 20.04 and higher)
- [MacOS binary](https://github.com/massalabs/massa/releases/download/TEST.22.1/massa_TEST.22.1_release_macos.tar.gz)
...
- install nigthly: ```rustup toolchain install nightly-2023-02-27```
...
- Install Chocolatey and run: ```choco install llvm cmake protoc```
...
- Install install protoc in your PATH, to be downloaded [here](https://github.com/protocolbuffers/protobuf/releases)
