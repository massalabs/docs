...
- [Windows executable](https://github.com/massalabs/massa/releases/download/MAIN.5.0/massa_MAIN.5.0_release_windows.zip)
- [Linux binary](https://github.com/massalabs/massa/releases/download/MAIN.5.0/massa_MAIN.5.0_release_linux.tar.gz) -
only works with libc2.28 and higher (for example Ubuntu 20.04 and higher)
- [MacOS binary](https://github.com/massalabs/massa/releases/download/MAIN.5.0/massa_MAIN.5.0_release_macos_aarch64.tar.gz)
- Other binaries can be found on https://github.com/massalabs/massa/releases/tag/MAIN.5.0
...
- checkout the latest tag: ```git checkout MAIN.5.0```
