...
Our smart contract system is released and run on the testnet. You can find the full documentation
[here](/docs/build/build-a-dapp/smart-contract/intro).

Our smart contract system includes some exciting features, such as self-wakeup, a bit like what is introduced
[here](https://arxiv.org/pdf/2102.10784.pdf).
...
If you have rolls, you also need to register the key used to buy rolls to start staking again [here](/docs/node/reward).
