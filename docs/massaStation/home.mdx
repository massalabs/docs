...
Another core module of *Massa Station* that is already available is the [Massa Wallet](/build/wallet/massa-station.mdx). It allows you to manage your Massa accounts, and sign and send transactions with an experience similar to a traditional browser-plugin wallet, but with enhanced security.

Massa also provides a node Manager module that allows you to administrate your Massa node directly from *Massa Station*. You can learn more about it [here](https://github.com/massalabs/station-massa-node-manager).
...
These certificates allow *Massa Station* to use the HTTPS protocol, which improves your security when [browsing dApp](browse-decentralized-application).
:::
