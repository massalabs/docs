...
The DeWeb Website Index Smart Contract is a decentralized registry that stores metadata for all on-chain websites.
This will later be used for indexing and decentralized search using the website metadatas.
...
<ProviderTable network="mainnet" />

### Buildnet Providers

<ProviderTable network="buildnet" />
