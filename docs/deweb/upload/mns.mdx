...
If you already have a MNS proceed to step 2.

If you have no MNS minted on your prefferred network than you can mint one using the UI. 

##### 2) Changing MSN Target

To have your MSN point at your website you need to chaneg the target address. 

By default this address targets the owner address. 

To change the target address navugate to the MNS you want to use to your website.
